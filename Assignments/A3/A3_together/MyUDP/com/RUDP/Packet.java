...
/**
 * com.RUDP.Packet represents a simulated network packet.
...
public class Packet {
    ...
    public Packet(int type, long sequenceNumber, long ackNumber, InetAddress peerAddress, int peerPort, byte[] payload) {
        this.type = type;
    ...
    public static class Builder {
        ...
        public Packet create() {
            return new Packet(type, sequenceNumber, ackNumber, peerAddress, portNumber, payload);
        }
    }
}
