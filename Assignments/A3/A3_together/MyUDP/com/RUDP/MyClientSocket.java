...
//    private final long totalSequenceNumber = 8;
    ...
    public MyClientSocket(int routerPort, int serverPort) {
    ...
    public void send(String data) {
        try {
            ...
            if (debugMessage) System.out.println("com.RUDP.MyClientSocket.send(): " + exception.getMessage());
        }
        handShake();
    ...
    private void handShake() {
        ...
        while (!connected) {
            try {
                ...
                System.out.println("com.RUDP.MyClientSocket.handShake(), step " + handShakeStep + " " + exception.getMessage());
            }
        }
    }
