...
//    private String contentType = "plain/text";
    ...
    handleClientRequest(MyServerSocket myServerSocket, boolean printDebugMessage, String directoryPath) {
...
//            br.close();
//            bw.close();
            myServerSocket.send(respond.toString());
    ...
    private void getClientRequest() throws Exception {
        String line;
        br = new BufferedReader(new StringReader(myServerSocket.receive()));
...
//            testBW.close();
    ...
    private void generateRespond() throws Exception {
        ...
        if (contentType.equals("image/jpeg")) respond.append("Content-Disposition: attachment; filename=imageFile.jpg").append(crlf);
        respond.append(crlf);
